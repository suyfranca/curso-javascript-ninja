(function(){
  ...
  */
  ...
  let norte = ['Amazonas', 'Pará', 'Amapá'];

  norte.forEach( function( item ) {
    brasil.unshift( item );  
  });
  ...
  */
  ...
  let newSul = brasil.filter( function(item){
    while (item == sul[0] || item == sul[1] || item == sul[2]){ 
        return item;
    }
});
  ...
  */
  let nordeste = [ 'Maranhão', 'Piauí', 'Ceará', 'Rio Grande do Norte',
...
console.log( 
  ...
  */
  ...
  let hasCeara = brasil.some( function( item ){
    return item === 'Ceará'
  });
