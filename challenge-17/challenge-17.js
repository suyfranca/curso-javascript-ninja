...
/*
  ...
  */
  ...
  let newText = text.replace( /Manuel Marques de Sousa/g , "Suyanne Pinto de França" );
  ...
  */
  ...
  newText = text.replace( /brasileiro/, 'cearense' );
  console.log( newText );
  ...
  */
  ...
  newText = text.replace( /[D-Za-h]/g, '0' );
  console.log( newText );
  ...
  */
  ...
  newText = text.replace( /O Centauro de Luvas/ , function(capturaTotal){
