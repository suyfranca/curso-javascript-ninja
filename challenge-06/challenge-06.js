...
*/
let championship = 'Campeonato Cearense';
...
desafio.
*/
let teams = [ 'Ceará', 'Ferroviário', 'Floresta', 'Guarany de Sobral', 'Horizonte' ];
...
console.log( convertToHex( 'green' ) ); //O hexadecimal para a cor green é #FFFF00.
...
console.log( convertToHex( 'yellow' ) ); //O hexadecimal para a cor yellow é #008000.
